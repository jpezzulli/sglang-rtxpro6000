...
class TestQsaCompressedWritePlan(CustomTestCase):
    def test_group_slot_is_any_raw_slot_over_ratio(self):
        ...
        write_locs, group_positions, sequence_ids, member_rows, valid, _ = _plan(
    ...
    def test_non_boundary_rows_only_pad_the_plan(self):
        ...
        write_locs, _, _, _, valid, _ = _plan(lengths=[253, 254, 255], table=table)
    ...
    def test_plan_is_compacted_in_row_order(self):
        ...
        write_locs, group_positions, sequence_ids, _, valid, _ = _plan(
    ...
    def test_extend_plan_covers_the_whole_chunk(self):
        ...
        write_locs, group_positions, _, member_rows, valid, _ = _plan(
        ...
        self.assertEqual(int(valid.sum()), groups)
